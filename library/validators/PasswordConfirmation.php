<?php
/**
 * PasswordConfirmation.php - Ee_Validate_PasswordConfirmation
 * Valida se o password que o cara digitou duas vezes são iguais
 * 
...
class Ee_Validate_PasswordConfirmation extends Zend_Validate_Abstract {
